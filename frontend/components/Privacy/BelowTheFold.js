function BelowTheFold() {
  return (
    <section>
      ...
      <h2>Use of Data</h2>
      <p>
        Benjamin Brooke&apos;s Web Development Blog uses the collected data for various purposes:
      </p>
      <ul>
      ...
      <p>
        If you are from the European Economic Area (EEA), Benjamin Brooke&apos;s Web Development
        Blog legal basis for collecting and using the personal information described in this Privacy
        Policy depends on the Personal Data we collect and the specific context in which we collect
        it.
      </p>
      <p>Benjamin Brooke&apos;s Web Development Blog may process your Personal Data because:</p>
      <ul>
      ...
      <p>
        Benjamin Brooke&apos;s Web Development Blog will retain your Personal Data only for as long
      ...
      <p>
        Benjamin Brooke&apos;s Web Development Blog will also retain Usage Data for internal
      ...
      <p>
        Benjamin Brooke&apos;s Web Development Blog will take all steps reasonably necessary to
        ensure that your data is treated securely and in accordance with this Privacy Policy and no
        transfer of your Personal Data will take place to an organization or a country unless there
      ...
      <p>
        Benjamin Brooke&apos;s Web Development Blog may disclose your Personal Data in the good
        faith belief that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>
          To protect and defend the rights or property of Benjamin Brooke&apos;s Web Development
          Blog
        </li>
      ...
      <p>
        ...
        rights. Benjamin Brooke&apos;s Web Development Blog aims to take reasonable steps to allow
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            consent at any time where Benjamin Brooke&apos;s Web Development Blog relied on your
      ...
      <ul>
        <li>By email: tech@bvgsoftware.com</li>
      </ul>
    </section>
  )
}
