...
var xe = Ce(async function (e, t) {
  if (
    (e.startsWith(ve) && (e = e.substring(ve.length)), /^(\w+:)|\/\//i.test(e))
  )
    return e
  ...
  if (
    (n.path && !we.test(n.path) && (n.path += '.js'),
    n.path && n.version && _e.test(n.version))
  )
    return `${ve}${n.name}@${n.version}/${n.path}`
  const r = await Ee(n)
  return `${ve}${r.name}@${r.version}/${
    n.path ||
    (function (e) {
      for (const t of ge) {
        const n = e[t]
...
function Ce(e) {
  ...
  function o(e) {
    return arguments.length > 1
      ? Promise.all(pe.call(arguments, n)).then(Ne)
      : n(e)
  }
  return (
    (o.alias = function (t) {
...
function Ne(e) {
  ...
  for (const n of e)
    for (const e in n)
      me.call(n, e) &&
        (null == n[e]
          ? Object.defineProperty(t, e, { get: Se(n, e) })
          : (t[e] = n[e]))
  return t
}
function Se(e, t) {
...
var ke = {
  ...
  element: function (e, t) {
    ...
    var o = $e.hasOwnProperty(r)
      ? document.createElementNS($e[r], e)
...
;(rt.prototype = Object.create(Error.prototype)),
  (rt.prototype.name = 'RuntimeError'),
...
function vt(e, t, n) {
  ...
  if (
    (this._inputs.forEach(pt, this),
    t.forEach(ft, this),
    (this._inputs = t),
    (this._definition = n),
    (this._value = void 0),
    n === ut ? i._variables.delete(this) : i._variables.add(this),
      ...
      ((a = r.get(e))
        ? 3 === a._type
          ...
          : ((a._duplicate = a._definition),
            (this._duplicate = n),
            ((o = new dt(3, this._module))._name = e),
            (o._definition = this._definition = a._definition = mt(e)),
...
function bt(e, t = []) {
  Object.defineProperties(this, {
    ...
    _builtins: {
      value: new Map([['invalidation', gt], ['visibility', yt], ...t]),
    },
  ...
  define: {
    value: function (e, t, n) {
      ...
      return vt.call(
        this,
        null == e ? null : e + '',
        null == t ? [] : ot.call(t, this._module._resolve, this._module),
        'function' == typeof n ? n : st(n)
      )
    },
    writable: !0,
    configurable: !0,
          ...
          if (!n || 1 !== n._type)
            if (a._definition === lt) {
              ...
              e.import(
                ...
                o,
                t.get(i) ||
                  (i._source ? i._copy(new bt(e._runtime, e._builtins), t) : i)
              )
    ...
    _resolve: {
      value: function (e) {
        var t,
          n = this._scope.get(e)
        if (!n)
          if (((n = new dt(2, this)), this._builtins.has(e)))
            n.define(e, st(this._builtins.get(e)))
...
function Lt(e, t) {
  e._invalidate(),
    ...
    ++e._version,
    (e._indegree = NaN),
    (e._promise = Promise.reject(t)).catch(ut),
    (e._value = void 0),
    e._rejected(t)
}
function jt(e) {
  ...
  Object.defineProperties(Et.prototype, {
      ...
      value: function () {
        ...
        do {
          for (
            ...
            Mt(t), t._outputs.forEach(r), e.delete(t)
          e.forEach(function (t) {
            xt(t) &&
              (Lt(t, new rt('circular definition')),
              t._outputs.forEach(Nt),
              e.delete(t))
          })
        } while (e.size)
        function r(e) {
    ...
    module: {
      value: function (e, t = ut) {
        let n
        if (void 0 === e)
          return (n = this._init) ? ((this._init = null), n) : new bt(this)
