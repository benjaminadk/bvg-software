...
# Simple Binary Search Tree`
  ...
  main
    ...
    .define(
      'viewof searchFor1',
      ['number', 'weBeSearchingOver1'],
      function (number, weBeSearchingOver1) {
        return number({
          min: 0,
  ...
  main
    ...
    .define(
      'linear1',
      ['weBeSearchingOver1', 'searchFor1', 'md'],
      function (weBeSearchingOver1, searchFor1, md) {
        var count = 0
  ...
  main
    ...
    .define(
      'binary1',
      ['recurs1', 'md', 'weBeSearchingOver1'],
      function (recurs1, md, weBeSearchingOver1) {
        return recurs1
...
Sumbit a value
  ...
  main
    ...
    .define(
      'viewof searchFor2',
      ['number', 'weBeSearchingOver2'],
      function (number, weBeSearchingOver2) {
        return number({
          min: 0,
  ...
  main
    ...
    .define(
      'linear2',
      ['weBeSearchingOver2', 'searchFor2', 'md'],
      function (weBeSearchingOver2, searchFor2, md) {
        var count = 0
...
Sumbit a value
  ...
  main
    ...
    .define(
      'viewof searchFor3',
      ['number', 'weBeSearchingOver3'],
      function (number, weBeSearchingOver3) {
        return number({
          min: 0,
  ...
  main
    .variable(observer())
    .define(
      ['weBeSearchingOver3', 'searchFor3', 'md'],
      function (weBeSearchingOver3, searchFor3, md) {
        var count = 0
